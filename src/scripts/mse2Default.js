...
var mSearch2 = {
			...
			$(document).on('click', this.options.pagination_link, function () {
			   if (!$(this).hasClass(mSearch2.options.active_class)) {
				  ...
				  mSearch2.load(params, function () {
						document.dispatchEvent(new CustomEvent("mse2_load_pagination"));
				  });
			   }
   ...
   beforeLoad: function () {
		document.dispatchEvent(new CustomEvent("mse2_before_load"));
   ...
   afterLoad: function () {
		document.dispatchEvent(new CustomEvent("mse2_after_load"));
